	   ...
	   <div class="form-panel">
		  ...
		  <form class="form-horizontal style-form" action="<?=base_url()?>relatives/edit/<?=$relative->id?>" method="post">
			  <div class="form-group">
				  ...
				  <div class="col-sm-10">
					  <input type="text" class="form-control" name="name" placeholder="Name" required value="<?=$relative->name?>">
				  </div>
			  </div>
			  <div class="form-group">
				  <label class="col-sm-2 col-sm-2 control-label">Relative email address</label>
				  <div class="col-sm-10">
					  <input type="email" class="form-control" name="email" placeholder="Email" required value="<?=$relative->email?>">
				  </div>
			  </div>
